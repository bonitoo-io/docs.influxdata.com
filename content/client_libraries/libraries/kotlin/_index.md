---
title: Using InfluxDB in Kotlin
---

Using InfluxDB platform with Kotlin 
=============

Kotlin is an modern OSS statically typed programming language that targets the JVM, Android, JavaScript and Native. 
It’s developed by [JetBrains](http://www.jetbrains.com/). 

Due to 100% interoperability with Java it is possible to use [influxdb-java](../java), [influxdb-java-reactive clients](../rxjava), 
[flux-java](../flux-java) or [flux-java-reactive](../flux-java-reactive)
client libraries. 
